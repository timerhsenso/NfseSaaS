        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InscricaoMunicipal = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroNfse = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ...
                    ValorServico = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    DescricaoServico = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    XmlDps = table.Column<string>(type: "text", nullable: true),
                    XmlNfse = table.Column<string>(type: "text", nullable: true),
                    CodigoErro = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoTributacaoNacional = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_audit_logs_TenantId_DataHora",
                table: "audit_logs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_notas_fiscais_TenantId_EmpresaId_NumeroDps_SerieDps",
                table: "notas_fiscais",
                columns: new[] { "TenantId", "EmpresaId", "NumeroDps", "SerieDps" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_servicos_TenantId_EmpresaId",
                table: "servicos",
