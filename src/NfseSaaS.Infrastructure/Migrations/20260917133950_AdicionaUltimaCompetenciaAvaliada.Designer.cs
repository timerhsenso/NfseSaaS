...
namespace NfseSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20260917133950_AdicionaUltimaCompetenciaAvaliada")]
    partial class AdicionaUltimaCompetenciaAvaliada
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NfseSaaS.Domain.Entities.CodigoNbs", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("codigos_nbs", (string)null);
                });

            modelBuilder.Entity("NfseSaaS.Domain.Entities.CodigoTributacaoNacional", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("codigos_tributacao_nacional", (string)null);
                });

            modelBuilder.Entity("NfseSaaS.Domain.Entities.ConfiguracaoAutomacaoNotaMensal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("CompetenciasSemConfirmacao")
                        .HasColumnType("integer");

                    b.Property<DateTimeOffset>("CreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<bool>("DesligadoPorInatividade")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateOnly?>("UltimaCompetenciaAvaliada")
                        .HasColumnType("date");
                    ...
                    b.ToTable("configuracoes_automacao_nota_mensal", (string)null);
                });

            modelBuilder.Entity("NfseSaaS.Domain.Entities.ContadorDps", b =>
                {
                    b.Property<Guid>("EmpresaId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NfseSaaS.Domain.Entities.Contrato", b =>
                {
                    ...
                    b.Property<bool>("PermitirAlterarValorNaEmissao")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("NfseSaaS.Domain.Entities.ContratoDocumento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("contrato_documentos", (string)null);
                });

            modelBuilder.Entity("NfseSaaS.Domain.Entities.ContratoServico", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("contrato_servicos", (string)null);
                });

            modelBuilder.Entity("NfseSaaS.Domain.Entities.EmailLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NfseSaaS.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ConviteAceitoEm")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("NfseSaaS.Domain.Entities.ConfiguracaoAutomacaoNotaMensal", b =>
                {
                    b.HasOne("NfseSaaS.Domain.Entities.Empresa", null)
                        .WithOne()
                        .HasForeignKey("NfseSaaS.Domain.Entities.ConfiguracaoAutomacaoNotaMensal", "EmpresaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
